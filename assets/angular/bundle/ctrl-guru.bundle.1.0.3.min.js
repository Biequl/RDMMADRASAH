...
angular.module("RdmApp").controller("raporCtrl",["$scope","$rootScope","common","DTOptionsBuilder","DTColumnBuilder","$http","$q","ApiServer","FileUploader",function(a,e,s,t,l,i,n,o,r){a.dtInstance={},a.dataEdit={},a.setnaikKelas=function(a,s){console.log(a),console.log(s),$.blockUI({}),o.post("guru/walas/naikkelas/"+e.walas,{siswa_id:a,absen_siswanaik:s},(function(a){$.unblockUI({}),a.success?(e.getwalassiswa(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Disimpan",timer:1e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:a.message}).then((a=>{a.value&&e.getwalassiswa()}))}))},a.savedataEdit=function(){$(".edit-modal").modal("hide"),$.blockUI({}),o.post("guru/siswa/save",a.dataEdit,(function(e){$.unblockUI({}),e.success?(a.reloadTable(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Disimpan",timer:1e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:e.message}).then((a=>{a.value&&($(".edit-modal").modal("show"),$(".modal-dialog").draggable({handle:".modal-header"}))}))}))},a.dodataDelete=function(e){Swal.fire({type:"warning",title:"Perhatian",confirmButtonText:"Yes, delete it!",showCancelButton:!0,html:"Apakah Anda yakin akan menghapus data ini?"}).then((s=>{s.value&&($.blockUI({}),o.post("guru/siswa/delete",{siswa_id:e},(function(e){$.unblockUI({}),e.success?(a.reloadTable(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data Berhasil Dihapus",timer:1e3})):Swal.fire({type:"error",title:"Gagal",showConfirmButton:!0,html:e.message})})))}))},a.reloadTable=function(){e.datasiswa={},""!==a.selectData.kelas_id&&e.getdatasiswa(a.selectData)},a.cetakAllNilai=function(s,t){console.log(s),console.log(e.walassiswa.length),s<e.walassiswa.length?($.blockUI({message:"Proses generate nilai "+e.walassiswa[s].siswa_nama+", <br> Proses data "+Math.round(100*(s+1)/e.walassiswa.length)+"% ("+(s+1)+" dari "+e.walassiswa.length+" siswa)."}),o.get("guru/rapor/gennilaipdf/"+e.walassiswa[s].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllNilai(s+1,0):t>2?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal generate nilai",timer:2e3}):a.cetakAllNilai(s,t+1)}))):a.openNewAjaxTab("guru/rapor/downnilaipdf/"+e.walas)},a.cetakAllRapor=function(s,t){console.log(s),console.log(e.walassiswa.length),s<e.walassiswa.length?($.blockUI({message:"Proses generate rapor "+e.walassiswa[s].siswa_nama+", <br> Proses data "+Math.round(100*(s+1)/e.walassiswa.length)+"% ("+(s+1)+" dari "+e.walassiswa.length+" siswa)."}),o.get("guru/rapor/genraporpdf/"+e.walassiswa[s].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllRapor(s+1,0):t>2?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal generate rapor",timer:2e3}):a.cetakAllRapor(s,t+1)}))):a.openNewAjaxTab("guru/rapor/downraporpdf/"+e.walas)},a.cetakAllSampul=function(s,t){console.log(s),console.log(e.walassiswa.length),s<e.walassiswa.length?($.blockUI({message:"Proses generate sampul "+e.walassiswa[s].siswa_nama+", <br> Proses data "+Math.round(100*(s+1)/e.walassiswa.length)+"% ("+(s+1)+" dari "+e.walassiswa.length+" siswa)."}),o.get("guru/rapor/gensampulsiswapdf/"+e.walassiswa[s].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllSampul(s+1,0):t>2?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal generate sampul",timer:2e3}):a.cetakAllSampul(s,t+1)}))):a.openNewAjaxTab("guru/rapor/downsampulpdf/"+e.walas)},a.cetakAllIdentitas=function(s,t){console.log(s),console.log(e.walassiswa.length),s<e.walassiswa.length?($.blockUI({message:"Proses generate identitas "+e.walassiswa[s].siswa_nama+", <br> Proses data "+Math.round(100*(s+1)/e.walassiswa.length)+"% ("+(s+1)+" dari "+e.walassiswa.length+" siswa)."}),o.get("guru/rapor/genidentitassiswapdf/"+e.walassiswa[s].siswa_id,(function(e){$.unblockUI({}),e.success?a.cetakAllIdentitas(s+1,0):t>2?Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal generate identitas",timer:2e3}):a.cetakAllIdentitas(s,t+1)}))):a.openNewAjaxTab("guru/rapor/downidentitaspdf/"+e.walas)},a.openNewAjaxTab=function(a){$.ajax({url:base_url+"guru/rapor/validasi",method:"GET",headers:{"Content-type":"application/json"},responseType:"arraybuffer",success:function(e){var s=a,t=document.createElement("a");t.href=s,t.target="_blank",t.download="Testing.pdf",document.body.appendChild(t),t.click(),Swal.fire({type:"success",title:"Berhasil",showConfirmButton:!1,html:"Data download",timer:2e3})},error:function(a){Swal.fire({type:"error",title:"Gagal",showConfirmButton:!1,html:"Gagal download",timer:2e3})}})},a.dodataEdit=function(e){a.dataEdit=e,$(".edit-modal").modal("show"),$(".modal-dialog").draggable({handle:".modal-header"})},a.selectData={},a.selectData.kelas_id="",a.selectData.tingkat_id="",a.dtOptions=t.newOptions().withOption("searching",!0).withOption("stateSave",!0).withOption("paging",!0).withOption("responsive",!0).withOption("processing",!0).withOption("columnDefs",[{responsivePriority:1,targets:-1},{responsivePriority:2,targets:2},{responsivePriority:3,targets:1},{responsivePriority:4,targets:0}]).withOption("drawCallback",(function(){$(".lazy").Lazy();try{a.$apply()}catch(a){}})).withPaginationType("full_numbers");var u=a.uploader=new r({url:base_url+"guru/siswa/import"});a.berhasilaa=0,a.gandaaa=0,a.gagalaa=0,a.hapussemua=function(){u.clearQueue(),a.berhasilaa=0,a.gandaaa=0,a.gagalaa=0},u.filters.push({name:"customFilter",fn:function(a,e){return this.queue.length<100}}),u.filters.push({name:"imageFilter",fn:function(a,e){var s="|"+a.name.substr(a.name.lastIndexOf(".")+1)+"|";return console.info("type",s),-1!=="|xls|xlsx|".indexOf(s)}}),u.onSuccessItem=function(e,s,t,l){a.berhasilka=a.berhasilka+s.sukses,a.gandaaa=a.gandaaa+s.double1,a.gagalaa=a.gagalaa+s.gagal,a.$apply(),console.info("onSuccessItem",e,s,t,l,a.gandaaa)},u.onCompleteAll=function(){a.reloadTable()},u.onBeforeUploadItem=function(e){e.url=base_url+"guru/siswa/import?kelas_id="+a.selectData.kelas_id+"&tingkat_id="+a.selectData.tingkat_id},u.onAfterAddingAll=function(a){u.uploadAll()}}]);
